...
{
        public class LoseMenuFunctions : MonoBehaviour, CanvasSystem.IOnCanvasEnabled
        {
                ...
                void CanvasSystem.IOnCanvasEnabled.OnCanvasEnable()
                {
                        References.backgroundMusic.Play(music.clip, AudioSystem.BackgroundMusic.Source.menu, music.volume);
                }
        }
}