...
namespace Gameplay.Player
{
        public abstract class PlayerInfo : MonoBehaviour, IOnPlayerPress, IOnGameplayEnd
        {
                ...
                public System.Action onTrinonAdd;
                public System.Action onTrinonRemove;
                #endregion
                ...
                public void SetHealth(float value)
                {
                        ...
                        if (value < 0) value = 0;
                        // shouldnt be able to die twice
                        if (value == 0 && m_stats.m_health == 0) return;
                ...
                public IEnumerator Lose()
                {
                        ...
                        References.gameController.OpenLoseMenu();
                }
